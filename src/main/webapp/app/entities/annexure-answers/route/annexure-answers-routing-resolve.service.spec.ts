...
describe('Service Tests', () => {
  describe('AnnexureAnswers routing resolve service', () => {
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(AnnexureAnswersRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AnnexureAnswers })));
        mockActivatedRouteSnapshot.params = { id: 123 };
