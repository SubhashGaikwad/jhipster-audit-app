...
export class AnnexureAnswersRoutingResolveService implements Resolve<IAnnexureAnswers> {
  constructor(protected service: AnnexureAnswersService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IAnnexureAnswers> | Observable<never> {
