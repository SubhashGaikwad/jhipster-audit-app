  ...
  describe('AnnexureAnswers Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a AnnexureAnswers', () => {
        ...
        service.create(new AnnexureAnswers()).subscribe(resp => (expectedResult = resp.body));
      ...
      describe('addAnnexureAnswersToCollectionIfMissing', () => {
        it('should add a AnnexureAnswers to an empty array', () => {
          ...
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing([], annexureAnswers);
        ...
        it('should not add a AnnexureAnswers to an array that contains it', () => {
          ...
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing(annexureAnswersCollection, annexureAnswers);
        ...
        it('should add only unique AnnexureAnswers to an array', () => {
          const annexureAnswersArray: IAnnexureAnswers[] = [{ id: 123 }, { id: 456 }, { id: 94210 }];
          const annexureAnswersCollection: IAnnexureAnswers[] = [{ id: 123 }];
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing(annexureAnswersCollection, ...annexureAnswersArray);
        ...
        it('should accept varargs', () => {
          ...
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing([], annexureAnswers, annexureAnswers2);
          expect(expectedResult).toHaveLength(2);
          expect(expectedResult).toContain(annexureAnswers);
        ...
        it('should accept null and undefined values', () => {
          const annexureAnswers: IAnnexureAnswers = { id: 123 };
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing([], null, annexureAnswers, undefined);
          expect(expectedResult).toHaveLength(1);
          expect(expectedResult).toContain(annexureAnswers);
        });
        ...
        it('should return initial array if no AnnexureAnswers is added', () => {
          const annexureAnswersCollection: IAnnexureAnswers[] = [{ id: 123 }];
          expectedResult = service.addAnnexureAnswersToCollectionIfMissing(annexureAnswersCollection, undefined, null);
