...
describe('Service Tests', () => {
  describe('AuditPatientMonitoringForm routing resolve service', () => {
    ...
    let resultAuditPatientMonitoringForm: IAuditPatientMonitoringForm | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(AuditPatientMonitoringFormRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IAuditPatientMonitoringForm if id is not provided', () => {
        ...
        expect(resultAuditPatientMonitoringForm).toEqual(new AuditPatientMonitoringForm());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AuditPatientMonitoringForm })));
        mockActivatedRouteSnapshot.params = { id: 123 };
