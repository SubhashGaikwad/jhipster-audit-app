  ...
  describe('AuditPatientMonitoringForm Management Detail Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(AuditPatientMonitoringFormDetailComponent);
    ...
    describe('OnInit', () => {
      it('Should load auditPatientMonitoringForm on init', () => {
        ...
        // THEN
        expect(comp.auditPatientMonitoringForm).toEqual(expect.objectContaining({ id: 123 }));
      });
    });
  });
});
