...
export class AuditPatientMonitoringFormUpdateComponent implements OnInit {
  ...
  save(): void {
    ...
    if (auditPatientMonitoringForm.id !== undefined) {
      this.subscribeToSaveResponse(this.auditPatientMonitoringFormService.update(auditPatientMonitoringForm));
    } else {
      this.subscribeToSaveResponse(this.auditPatientMonitoringFormService.create(auditPatientMonitoringForm));
    }
  }

  protected subscribeToSaveResponse(result: Observable<HttpResponse<IAuditPatientMonitoringForm>>): void {
  ...
  protected updateForm(auditPatientMonitoringForm: IAuditPatientMonitoringForm): void {
