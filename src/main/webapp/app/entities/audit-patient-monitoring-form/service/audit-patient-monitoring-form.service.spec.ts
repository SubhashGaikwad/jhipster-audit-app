...
import { IAuditPatientMonitoringForm, AuditPatientMonitoringForm } from '../audit-patient-monitoring-form.model';
...
describe('Service Tests', () => {
  describe('AuditPatientMonitoringForm Service', () => {
    ...
    let expectedResult: IAuditPatientMonitoringForm | IAuditPatientMonitoringForm[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a AuditPatientMonitoringForm', () => {
        ...
        service.create(new AuditPatientMonitoringForm()).subscribe(resp => (expectedResult = resp.body));
      ...
      describe('addAuditPatientMonitoringFormToCollectionIfMissing', () => {
        it('should add a AuditPatientMonitoringForm to an empty array', () => {
          const auditPatientMonitoringForm: IAuditPatientMonitoringForm = { id: 123 };
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing([], auditPatientMonitoringForm);
        ...
        it('should not add a AuditPatientMonitoringForm to an array that contains it', () => {
          ...
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing(
        ...
        it("should add a AuditPatientMonitoringForm to an array that doesn't contain it", () => {
          const auditPatientMonitoringForm: IAuditPatientMonitoringForm = { id: 123 };
          const auditPatientMonitoringFormCollection: IAuditPatientMonitoringForm[] = [{ id: 456 }];
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing(
            auditPatientMonitoringFormCollection,
            auditPatientMonitoringForm
          );
        ...
        it('should add only unique AuditPatientMonitoringForm to an array', () => {
          const auditPatientMonitoringFormArray: IAuditPatientMonitoringForm[] = [{ id: 123 }, { id: 456 }, { id: 47724 }];
          const auditPatientMonitoringFormCollection: IAuditPatientMonitoringForm[] = [{ id: 123 }];
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing(
            auditPatientMonitoringFormCollection,
        ...
        it('should accept varargs', () => {
          const auditPatientMonitoringForm: IAuditPatientMonitoringForm = { id: 123 };
          const auditPatientMonitoringForm2: IAuditPatientMonitoringForm = { id: 456 };
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing(
            [],
            auditPatientMonitoringForm,
        ...
        it('should accept null and undefined values', () => {
          const auditPatientMonitoringForm: IAuditPatientMonitoringForm = { id: 123 };
          expectedResult = service.addAuditPatientMonitoringFormToCollectionIfMissing([], null, auditPatientMonitoringForm, undefined);
          expect(expectedResult).toHaveLength(1);
          expect(expectedResult).toContain(auditPatientMonitoringForm);
        });
