...
describe('Service Tests', () => {
  describe('AnnexureQuestions Service', () => {
    ...
    let expectedResult: IAnnexureQuestions | IAnnexureQuestions[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a AnnexureQuestions', () => {
        ...
        service.create(new AnnexureQuestions()).subscribe(resp => (expectedResult = resp.body));
      ...
      describe('addAnnexureQuestionsToCollectionIfMissing', () => {
        it('should add a AnnexureQuestions to an empty array', () => {
          ...
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing([], annexureQuestions);
        ...
        it('should not add a AnnexureQuestions to an array that contains it', () => {
          ...
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing(annexureQuestionsCollection, annexureQuestions);
          expect(expectedResult).toHaveLength(2);
        });

        it("should add a AnnexureQuestions to an array that doesn't contain it", () => {
          const annexureQuestions: IAnnexureQuestions = { id: 123 };
          const annexureQuestionsCollection: IAnnexureQuestions[] = [{ id: 456 }];
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing(annexureQuestionsCollection, annexureQuestions);
          expect(expectedResult).toHaveLength(2);
          expect(expectedResult).toContain(annexureQuestions);
        });
        ...
        it('should add only unique AnnexureQuestions to an array', () => {
          const annexureQuestionsArray: IAnnexureQuestions[] = [{ id: 123 }, { id: 456 }, { id: 92570 }];
          const annexureQuestionsCollection: IAnnexureQuestions[] = [{ id: 123 }];
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing(annexureQuestionsCollection, ...annexureQuestionsArray);
        ...
        it('should accept varargs', () => {
          ...
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing([], annexureQuestions, annexureQuestions2);
          expect(expectedResult).toHaveLength(2);
          expect(expectedResult).toContain(annexureQuestions);
        ...
        it('should accept null and undefined values', () => {
          const annexureQuestions: IAnnexureQuestions = { id: 123 };
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing([], null, annexureQuestions, undefined);
          expect(expectedResult).toHaveLength(1);
          expect(expectedResult).toContain(annexureQuestions);
        });
        ...
        it('should return initial array if no AnnexureQuestions is added', () => {
          const annexureQuestionsCollection: IAnnexureQuestions[] = [{ id: 123 }];
          expectedResult = service.addAnnexureQuestionsToCollectionIfMissing(annexureQuestionsCollection, undefined, null);
