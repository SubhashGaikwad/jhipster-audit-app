...
describe('Service Tests', () => {
  describe('AnnexureQuestions routing resolve service', () => {
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(AnnexureQuestionsRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AnnexureQuestions })));
        mockActivatedRouteSnapshot.params = { id: 123 };
