...
export class AnnexureQuestionsRoutingResolveService implements Resolve<IAnnexureQuestions> {
  constructor(protected service: AnnexureQuestionsService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<IAnnexureQuestions> | Observable<never> {
