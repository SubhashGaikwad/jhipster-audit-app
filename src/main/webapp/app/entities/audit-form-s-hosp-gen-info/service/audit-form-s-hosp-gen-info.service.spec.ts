...
describe('Service Tests', () => {
  describe('AuditFormSHospGenInfo Service', () => {
    ...
    let expectedResult: IAuditFormSHospGenInfo | IAuditFormSHospGenInfo[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a AuditFormSHospGenInfo', () => {
        ...
        service.create(new AuditFormSHospGenInfo()).subscribe(resp => (expectedResult = resp.body));
      ...
      describe('addAuditFormSHospGenInfoToCollectionIfMissing', () => {
        it('should add a AuditFormSHospGenInfo to an empty array', () => {
          ...
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing([], auditFormSHospGenInfo);
        ...
        it('should not add a AuditFormSHospGenInfo to an array that contains it', () => {
          ...
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing(auditFormSHospGenInfoCollection, auditFormSHospGenInfo);
          expect(expectedResult).toHaveLength(2);
        });

        it("should add a AuditFormSHospGenInfo to an array that doesn't contain it", () => {
          const auditFormSHospGenInfo: IAuditFormSHospGenInfo = { id: 123 };
          const auditFormSHospGenInfoCollection: IAuditFormSHospGenInfo[] = [{ id: 456 }];
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing(auditFormSHospGenInfoCollection, auditFormSHospGenInfo);
          expect(expectedResult).toHaveLength(2);
          expect(expectedResult).toContain(auditFormSHospGenInfo);
        });
        ...
        it('should add only unique AuditFormSHospGenInfo to an array', () => {
          const auditFormSHospGenInfoArray: IAuditFormSHospGenInfo[] = [{ id: 123 }, { id: 456 }, { id: 9910 }];
          const auditFormSHospGenInfoCollection: IAuditFormSHospGenInfo[] = [{ id: 123 }];
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing(
        ...
        it('should accept varargs', () => {
          ...
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing([], auditFormSHospGenInfo, auditFormSHospGenInfo2);
          expect(expectedResult).toHaveLength(2);
          expect(expectedResult).toContain(auditFormSHospGenInfo);
        ...
        it('should accept null and undefined values', () => {
          const auditFormSHospGenInfo: IAuditFormSHospGenInfo = { id: 123 };
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing([], null, auditFormSHospGenInfo, undefined);
          expect(expectedResult).toHaveLength(1);
          expect(expectedResult).toContain(auditFormSHospGenInfo);
        });
        ...
        it('should return initial array if no AuditFormSHospGenInfo is added', () => {
          const auditFormSHospGenInfoCollection: IAuditFormSHospGenInfo[] = [{ id: 123 }];
          expectedResult = service.addAuditFormSHospGenInfoToCollectionIfMissing(auditFormSHospGenInfoCollection, undefined, null);
