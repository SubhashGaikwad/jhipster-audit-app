...
describe('Service Tests', () => {
  describe('AuditFormSHospGenInfo routing resolve service', () => {
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(AuditFormSHospGenInfoRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IAuditFormSHospGenInfo if id is not provided', () => {
        ...
        expect(resultAuditFormSHospGenInfo).toEqual(new AuditFormSHospGenInfo());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as AuditFormSHospGenInfo })));
        mockActivatedRouteSnapshot.params = { id: 123 };
