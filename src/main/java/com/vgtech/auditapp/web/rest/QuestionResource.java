...
import com.vgtech.auditapp.domain.Question;
import com.vgtech.auditapp.repository.QuestionRepository;
...
/**
 * REST controller for managing {@link com.vgtech.auditapp.domain.Question}.
 */
@RestController
@RequestMapping("/api")
@Transactional
