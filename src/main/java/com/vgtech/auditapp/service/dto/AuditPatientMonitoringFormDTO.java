 ...
 */
public class AuditPatientMonitoringFormDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuditPatientMonitoringFormDTO)) {
            return false;
        }

        AuditPatientMonitoringFormDTO auditPatientMonitoringFormDTO = (AuditPatientMonitoringFormDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, auditPatientMonitoringFormDTO.id);
    }
    ...
    public String toString() {
        return "AuditPatientMonitoringFormDTO{" +
            "id=" + getId() +
            ", wardNo=" + getWardNo() +
