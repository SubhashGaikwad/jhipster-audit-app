...
public class AuditDTO implements Serializable {
    ...
    private AuditFormSHospGenInfoDTO auditFormSHospGenInfo;
    ...
    public void setAuditPatientMonitoringForm(AuditPatientMonitoringFormDTO auditPatientMonitoringForm) {
        this.auditPatientMonitoringForm = auditPatientMonitoringForm;
    }

    public AuditFormSHospGenInfoDTO getAuditFormSHospGenInfo() {
        return auditFormSHospGenInfo;
    }

    public void setAuditFormSHospGenInfo(AuditFormSHospGenInfoDTO auditFormSHospGenInfo) {
    ...
    public String toString() {
        return "AuditDTO{" +
            ...
            ", auditFormSHospGenInfo=" + getAuditFormSHospGenInfo() +
            "}";
    }
}
