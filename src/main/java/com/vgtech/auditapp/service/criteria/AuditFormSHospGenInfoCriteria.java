...
public class AuditFormSHospGenInfoCriteria implements Serializable, Criteria {
    ...
    public AuditFormSHospGenInfoCriteria(AuditFormSHospGenInfoCriteria other) {
        ...
        this.inchargeName = other.inchargeName == null ? null : other.inchargeName.copy();
        this.hospAddress = other.hospAddress == null ? null : other.hospAddress.copy();
        this.hospPhoneNo = other.hospPhoneNo == null ? null : other.hospPhoneNo.copy();
        ...
        this.ventilatorBeds = other.ventilatorBeds == null ? null : other.ventilatorBeds.copy();
        this.icuBeds = other.icuBeds == null ? null : other.icuBeds.copy();
        this.onCylinderPatient = other.onCylinderPatient == null ? null : other.onCylinderPatient.copy();
        this.onPipedBedsPatient = other.onPipedBedsPatient == null ? null : other.onPipedBedsPatient.copy();
        this.onNIV = other.onNIV == null ? null : other.onNIV.copy();
        this.onIntubated = other.onIntubated == null ? null : other.onIntubated.copy();
        this.jumboSystemInstalledType = other.jumboSystemInstalledType == null ? null : other.jumboSystemInstalledType.copy();
        this.availableCylinderTypeD7 = other.availableCylinderTypeD7 == null ? null : other.availableCylinderTypeD7.copy();
        this.availableCylinderTypeB = other.availableCylinderTypeB == null ? null : other.availableCylinderTypeB.copy();
        this.cylinderAgencyName = other.cylinderAgencyName == null ? null : other.cylinderAgencyName.copy();
        this.cylinderAgencyAddress = other.cylinderAgencyAddress == null ? null : other.cylinderAgencyAddress.copy();
        this.availableLMOCapacityKL = other.availableLMOCapacityKL == null ? null : other.availableLMOCapacityKL.copy();
        this.lmoSupplierName = other.lmoSupplierName == null ? null : other.lmoSupplierName.copy();
        this.lmoSupplierFrequency = other.lmoSupplierFrequency == null ? null : other.lmoSupplierFrequency.copy();
        this.lastLmoSuppliedQuantity = other.lastLmoSuppliedQuantity == null ? null : other.lastLmoSuppliedQuantity.copy();
    ...
    public void setJumboSystemInstalledType(StringFilter jumboSystemInstalledType) {
    ...
    public void setAvailableCylinderTypeD7(IntegerFilter availableCylinderTypeD7) {
