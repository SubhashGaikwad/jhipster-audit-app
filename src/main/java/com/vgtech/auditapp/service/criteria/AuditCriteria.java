...
public class AuditCriteria implements Serializable, Criteria {
    ...
    public AuditCriteria(AuditCriteria other) {
        ...
        this.isAuditComplete = other.isAuditComplete == null ? null : other.isAuditComplete.copy();
        ...
        this.auditPatientMonitoringFormId = other.auditPatientMonitoringFormId == null ? null : other.auditPatientMonitoringFormId.copy();
        this.annexureAnswersId = other.annexureAnswersId == null ? null : other.annexureAnswersId.copy();
        this.annexureQuestionsId = other.annexureQuestionsId == null ? null : other.annexureQuestionsId.copy();
        this.auditFormSHospGenInfoId = other.auditFormSHospGenInfoId == null ? null : other.auditFormSHospGenInfoId.copy();
    ...
    public void setAuditPatientMonitoringFormId(LongFilter auditPatientMonitoringFormId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(auditPatientMonitoringFormId, that.auditPatientMonitoringFormId) &&
