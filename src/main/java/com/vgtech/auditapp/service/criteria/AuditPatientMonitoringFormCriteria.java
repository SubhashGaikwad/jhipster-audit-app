 ...
 */
public class AuditPatientMonitoringFormCriteria implements Serializable, Criteria {
    ...
    public AuditPatientMonitoringFormCriteria(AuditPatientMonitoringFormCriteria other) {
        ...
        this.dateOfAdmission = other.dateOfAdmission == null ? null : other.dateOfAdmission.copy();
        this.oxygenType = other.oxygenType == null ? null : other.oxygenType.copy();
        this.sixToEightAM = other.sixToEightAM == null ? null : other.sixToEightAM.copy();
        this.oxySixToEightAM = other.oxySixToEightAM == null ? null : other.oxySixToEightAM.copy();
        this.eightToTenAM = other.eightToTenAM == null ? null : other.eightToTenAM.copy();
        this.oxyEightToTenAM = other.oxyEightToTenAM == null ? null : other.oxyEightToTenAM.copy();
        this.tenToTwelveAM = other.tenToTwelveAM == null ? null : other.tenToTwelveAM.copy();
        this.oxyTenToTwelveAM = other.oxyTenToTwelveAM == null ? null : other.oxyTenToTwelveAM.copy();
        this.twelveToTowPM = other.twelveToTowPM == null ? null : other.twelveToTowPM.copy();
        this.oxyTwelveToTowPM = other.oxyTwelveToTowPM == null ? null : other.oxyTwelveToTowPM.copy();
        this.twoToFourPM = other.twoToFourPM == null ? null : other.twoToFourPM.copy();
        this.oxyTwoToFourPM = other.oxyTwoToFourPM == null ? null : other.oxyTwoToFourPM.copy();
        this.fourToSixPM = other.fourToSixPM == null ? null : other.fourToSixPM.copy();
        this.oxyFourToSixPM = other.oxyFourToSixPM == null ? null : other.oxyFourToSixPM.copy();
        this.sixToEightPM = other.sixToEightPM == null ? null : other.sixToEightPM.copy();
        this.oxySixToEightPM = other.oxySixToEightPM == null ? null : other.oxySixToEightPM.copy();
        this.eightToTenPM = other.eightToTenPM == null ? null : other.eightToTenPM.copy();
        this.oxyEightToTenPM = other.oxyEightToTenPM == null ? null : other.oxyEightToTenPM.copy();
        this.tenToTwelvePM = other.tenToTwelvePM == null ? null : other.tenToTwelvePM.copy();
        this.oxyTenToTwelvePM = other.oxyTenToTwelvePM == null ? null : other.oxyTenToTwelvePM.copy();
        this.twelveToTwoAM = other.twelveToTwoAM == null ? null : other.twelveToTwoAM.copy();
        this.oxyTwelveToTwoAM = other.oxyTwelveToTwoAM == null ? null : other.oxyTwelveToTwoAM.copy();
        this.twoToFourAM = other.twoToFourAM == null ? null : other.twoToFourAM.copy();
        this.oxyTwoToFourAM = other.oxyTwoToFourAM == null ? null : other.oxyTwoToFourAM.copy();
        this.fourToSixAM = other.fourToSixAM == null ? null : other.fourToSixAM.copy();
        this.oxyFourToSixAM = other.oxyFourToSixAM == null ? null : other.oxyFourToSixAM.copy();
