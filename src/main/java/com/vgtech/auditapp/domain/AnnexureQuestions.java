...
public class AnnexureQuestions implements Serializable {
    ...
    public AnnexureQuestions annexureAnswers(Set<AnnexureAnswers> annexureAnswers) {
    ...
    public AnnexureQuestions removeAnnexureAnswers(AnnexureAnswers annexureAnswers) {
    ...
    public AnnexureQuestions audit(Audit audit) {
        this.setAudit(audit);
        return this;
    }
