...
public class AuditFormSHospGenInfo implements Serializable {
    ...
    @OneToMany(mappedBy = "auditFormSHospGenInfo")
    @JsonIgnoreProperties(
        value = { "auditPatientMonitoringForm", "annexureAnswers", "annexureQuestions", "auditFormSHospGenInfo" },
        allowSetters = true
    )
    ...
    public AuditFormSHospGenInfo jumboSystemInstalledType(String jumboSystemInstalledType) {
    ...
    public AuditFormSHospGenInfo availableCylinderTypeD7(Integer availableCylinderTypeD7) {
    ...
    public AuditFormSHospGenInfo availableCylinderTypeB(Integer availableCylinderTypeB) {
    ...
    public AuditFormSHospGenInfo cylinderAgencyAddress(String cylinderAgencyAddress) {
    ...
    public AuditFormSHospGenInfo availableLMOCapacityKL(Double availableLMOCapacityKL) {
    ...
    public AuditFormSHospGenInfo lmoSupplierFrequency(Integer lmoSupplierFrequency) {
    ...
    public AuditFormSHospGenInfo lastLmoSuppliedQuantity(Double lastLmoSuppliedQuantity) {
    ...
    public void setAudits(Set<Audit> audits) {
        if (this.audits != null) {
            this.audits.forEach(i -> i.setAuditFormSHospGenInfo(null));
        }
        if (audits != null) {
            audits.forEach(i -> i.setAuditFormSHospGenInfo(this));
        }
        this.audits = audits;
    }

    public AuditFormSHospGenInfo audits(Set<Audit> audits) {
        this.setAudits(audits);
        return this;
    }

    public AuditFormSHospGenInfo addAudit(Audit audit) {
        this.audits.add(audit);
        audit.setAuditFormSHospGenInfo(this);
        return this;
    }

    public AuditFormSHospGenInfo removeAudit(Audit audit) {
        this.audits.remove(audit);
        audit.setAuditFormSHospGenInfo(null);
        return this;
    }
