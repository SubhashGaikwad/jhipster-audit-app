...
class AuditResourceIT {
    ...
    void createAudit() throws Exception {
        ...
        assertThat(testAudit.getIsAuditComplete()).isEqualTo(DEFAULT_IS_AUDIT_COMPLETE);
    ...
    void getAllAudits() throws Exception {
        ...
        restAuditMockMvc
            ...
            .andExpect(jsonPath("$.[*].isAuditComplete").value(hasItem(DEFAULT_IS_AUDIT_COMPLETE.booleanValue())))
    ...
    void getAudit() throws Exception {
        ...
        restAuditMockMvc
            ...
            .andExpect(jsonPath("$.isAuditComplete").value(DEFAULT_IS_AUDIT_COMPLETE.booleanValue()))
    ...
    void getAllAuditsByAuditDateIsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("auditDate.in=" + DEFAULT_AUDIT_DATE + "," + UPDATED_AUDIT_DATE);
    ...
    @Test
    @Transactional
    void getAllAuditsByAuditDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);

        // Get all the auditList where auditDate is greater than or equal to DEFAULT_AUDIT_DATE
        defaultAuditShouldBeFound("auditDate.greaterThanOrEqual=" + DEFAULT_AUDIT_DATE);

        // Get all the auditList where auditDate is greater than or equal to UPDATED_AUDIT_DATE
        defaultAuditShouldNotBeFound("auditDate.greaterThanOrEqual=" + UPDATED_AUDIT_DATE);
    }
    ...
    void getAllAuditsByAuditDateIsLessThanOrEqualToSomething() throws Exception {
        ...
        defaultAuditShouldBeFound("auditDate.lessThanOrEqual=" + DEFAULT_AUDIT_DATE);

        // Get all the auditList where auditDate is less than or equal to SMALLER_AUDIT_DATE
        defaultAuditShouldNotBeFound("auditDate.lessThanOrEqual=" + SMALLER_AUDIT_DATE);
    }
    ...
    void getAllAuditsByHospNameIsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("hospName.in=" + DEFAULT_HOSP_NAME + "," + UPDATED_HOSP_NAME);
    ...
    void getAllAuditsByHospNameNotContainsSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("hospName.doesNotContain=" + DEFAULT_HOSP_NAME);
    ...
    void getAllAuditsByIsAuditCompleteIsEqualToSomething() throws Exception {
        ...
        defaultAuditShouldBeFound("isAuditComplete.equals=" + DEFAULT_IS_AUDIT_COMPLETE);

        // Get all the auditList where isAuditComplete equals to UPDATED_IS_AUDIT_COMPLETE
        defaultAuditShouldNotBeFound("isAuditComplete.equals=" + UPDATED_IS_AUDIT_COMPLETE);
    }
    ...
    void getAllAuditsByIsAuditCompleteIsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("isAuditComplete.notEquals=" + DEFAULT_IS_AUDIT_COMPLETE);

        // Get all the auditList where isAuditComplete not equals to UPDATED_IS_AUDIT_COMPLETE
        defaultAuditShouldBeFound("isAuditComplete.notEquals=" + UPDATED_IS_AUDIT_COMPLETE);
    }
    ...
    void getAllAuditsByIsAuditCompleteIsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("isAuditComplete.in=" + DEFAULT_IS_AUDIT_COMPLETE + "," + UPDATED_IS_AUDIT_COMPLETE);

        // Get all the auditList where isAuditComplete equals to UPDATED_IS_AUDIT_COMPLETE
        defaultAuditShouldNotBeFound("isAuditComplete.in=" + UPDATED_IS_AUDIT_COMPLETE);
    }
    ...
    void getAllAuditsByFreeField1IsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField1.notEquals=" + DEFAULT_FREE_FIELD_1);
    ...
    void getAllAuditsByFreeField1IsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("freeField1.in=" + DEFAULT_FREE_FIELD_1 + "," + UPDATED_FREE_FIELD_1);
    ...
    void getAllAuditsByFreeField1NotContainsSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField1.doesNotContain=" + DEFAULT_FREE_FIELD_1);

        // Get all the auditList where freeField1 does not contain UPDATED_FREE_FIELD_1
        defaultAuditShouldBeFound("freeField1.doesNotContain=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAuditsByFreeField2IsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField2.notEquals=" + DEFAULT_FREE_FIELD_2);
    ...
    void getAllAuditsByFreeField2IsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("freeField2.in=" + DEFAULT_FREE_FIELD_2 + "," + UPDATED_FREE_FIELD_2);
    ...
    void getAllAuditsByFreeField2NotContainsSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField2.doesNotContain=" + DEFAULT_FREE_FIELD_2);

        // Get all the auditList where freeField2 does not contain UPDATED_FREE_FIELD_2
        defaultAuditShouldBeFound("freeField2.doesNotContain=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAuditsByFreeField3IsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField3.notEquals=" + DEFAULT_FREE_FIELD_3);
    ...
    void getAllAuditsByFreeField3IsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("freeField3.in=" + DEFAULT_FREE_FIELD_3 + "," + UPDATED_FREE_FIELD_3);
    ...
    void getAllAuditsByFreeField3NotContainsSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField3.doesNotContain=" + DEFAULT_FREE_FIELD_3);

        // Get all the auditList where freeField3 does not contain UPDATED_FREE_FIELD_3
        defaultAuditShouldBeFound("freeField3.doesNotContain=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAuditsByFreeField4IsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField4.notEquals=" + DEFAULT_FREE_FIELD_4);
    ...
    void getAllAuditsByFreeField4IsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("freeField4.in=" + DEFAULT_FREE_FIELD_4 + "," + UPDATED_FREE_FIELD_4);
    ...
    void getAllAuditsByFreeField4NotContainsSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("freeField4.doesNotContain=" + DEFAULT_FREE_FIELD_4);

        // Get all the auditList where freeField4 does not contain UPDATED_FREE_FIELD_4
        defaultAuditShouldBeFound("freeField4.doesNotContain=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAuditsByRemarkIsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("remark.in=" + DEFAULT_REMARK + "," + UPDATED_REMARK);
    ...
    void getAllAuditsByCreatedDateIsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);
    ...
    @Test
    @Transactional
    void getAllAuditsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);

        // Get all the auditList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultAuditShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the auditList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultAuditShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAuditsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);

        // Get all the auditList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultAuditShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the auditList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultAuditShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }
    ...
    void getAllAuditsByCreatedDateIsLessThanSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);
    ...
    void getAllAuditsByCreatedDateIsGreaterThanSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the auditList where createdDate is greater than SMALLER_CREATED_DATE
        defaultAuditShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    void getAllAuditsByLastModifiedIsEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("lastModified.equals=" + UPDATED_LAST_MODIFIED);
    }
    ...
    void getAllAuditsByLastModifiedIsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("lastModified.notEquals=" + DEFAULT_LAST_MODIFIED);

        // Get all the auditList where lastModified not equals to UPDATED_LAST_MODIFIED
        defaultAuditShouldBeFound("lastModified.notEquals=" + UPDATED_LAST_MODIFIED);
    }
    ...
    void getAllAuditsByLastModifiedIsInShouldWork() throws Exception {
        ...
        defaultAuditShouldBeFound("lastModified.in=" + DEFAULT_LAST_MODIFIED + "," + UPDATED_LAST_MODIFIED);
    ...
    @Test
    @Transactional
    void getAllAuditsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);

        // Get all the auditList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultAuditShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the auditList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultAuditShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAuditsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);

        // Get all the auditList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultAuditShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the auditList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultAuditShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }
    ...
    void getAllAuditsByLastModifiedIsLessThanSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);
    ...
    void getAllAuditsByLastModifiedIsGreaterThanSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the auditList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultAuditShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }
    ...
    void getAllAuditsByLastModifiedByIsNotEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("lastModifiedBy.notEquals=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the auditList where lastModifiedBy not equals to UPDATED_LAST_MODIFIED_BY
        defaultAuditShouldBeFound("lastModifiedBy.notEquals=" + UPDATED_LAST_MODIFIED_BY);
    }
    ...
    @Test
    @Transactional
    void getAllAuditsByAuditPatientMonitoringFormIsEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);
        AuditPatientMonitoringForm auditPatientMonitoringForm;
        if (TestUtil.findAll(em, AuditPatientMonitoringForm.class).isEmpty()) {
            auditPatientMonitoringForm = AuditPatientMonitoringFormResourceIT.createEntity(em);
            em.persist(auditPatientMonitoringForm);
            em.flush();
        } else {
            auditPatientMonitoringForm = TestUtil.findAll(em, AuditPatientMonitoringForm.class).get(0);
        }
        em.persist(auditPatientMonitoringForm);
        em.flush();
        ...
        defaultAuditShouldBeFound("auditPatientMonitoringFormId.equals=" + auditPatientMonitoringFormId);

        // Get all the auditList where auditPatientMonitoringForm equals to (auditPatientMonitoringFormId + 1)
        defaultAuditShouldNotBeFound("auditPatientMonitoringFormId.equals=" + (auditPatientMonitoringFormId + 1));
    }
    ...
    void getAllAuditsByAnnexureAnswersIsEqualToSomething() throws Exception {
        ...
        defaultAuditShouldNotBeFound("annexureAnswersId.equals=" + (annexureAnswersId + 1));
    }

    @Test
    @Transactional
    void getAllAuditsByAnnexureQuestionsIsEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);
        ...
        em.persist(annexureQuestions);
        em.flush();
        audit.addAnnexureQuestions(annexureQuestions);
        auditRepository.saveAndFlush(audit);
        Long annexureQuestionsId = annexureQuestions.getId();

        // Get all the auditList where annexureQuestions equals to annexureQuestionsId
        defaultAuditShouldBeFound("annexureQuestionsId.equals=" + annexureQuestionsId);

        // Get all the auditList where annexureQuestions equals to (annexureQuestionsId + 1)
        defaultAuditShouldNotBeFound("annexureQuestionsId.equals=" + (annexureQuestionsId + 1));
    }

    @Test
    @Transactional
    void getAllAuditsByAuditFormSHospGenInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        auditRepository.saveAndFlush(audit);
        ...
        if (TestUtil.findAll(em, AuditFormSHospGenInfo.class).isEmpty()) {
            ...
            auditFormSHospGenInfo = TestUtil.findAll(em, AuditFormSHospGenInfo.class).get(0);
        }
        em.persist(auditFormSHospGenInfo);
        em.flush();
        audit.setAuditFormSHospGenInfo(auditFormSHospGenInfo);
        auditRepository.saveAndFlush(audit);
        ...
        defaultAuditShouldBeFound("auditFormSHospGenInfoId.equals=" + auditFormSHospGenInfoId);

        // Get all the auditList where auditFormSHospGenInfo equals to (auditFormSHospGenInfoId + 1)
        defaultAuditShouldNotBeFound("auditFormSHospGenInfoId.equals=" + (auditFormSHospGenInfoId + 1));
    }
    ...
    void putNewAudit() throws Exception {
        ...
        assertThat(testAudit.getIsAuditComplete()).isEqualTo(UPDATED_IS_AUDIT_COMPLETE);
