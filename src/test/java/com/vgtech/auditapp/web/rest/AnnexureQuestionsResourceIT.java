...
class AnnexureQuestionsResourceIT {
    ...
    void createAnnexureQuestions() throws Exception {
        ...
        AnnexureQuestionsDTO annexureQuestionsDTO = annexureQuestionsMapper.toDto(annexureQuestions);
        ...
        AnnexureQuestions testAnnexureQuestions = annexureQuestionsList.get(annexureQuestionsList.size() - 1);
        assertThat(testAnnexureQuestions.getFormName()).isEqualTo(DEFAULT_FORM_NAME);
        ...
        assertThat(testAnnexureQuestions.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testAnnexureQuestions.getFreeField1()).isEqualTo(DEFAULT_FREE_FIELD_1);
        assertThat(testAnnexureQuestions.getFreeField2()).isEqualTo(DEFAULT_FREE_FIELD_2);
        assertThat(testAnnexureQuestions.getFreeField3()).isEqualTo(DEFAULT_FREE_FIELD_3);
        assertThat(testAnnexureQuestions.getFreeField4()).isEqualTo(DEFAULT_FREE_FIELD_4);
        assertThat(testAnnexureQuestions.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testAnnexureQuestions.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testAnnexureQuestions.getLastModified()).isEqualTo(DEFAULT_LAST_MODIFIED);
        assertThat(testAnnexureQuestions.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
    }
    ...
    void getAllAnnexureQuestions() throws Exception {
        ...
        restAnnexureQuestionsMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(annexureQuestions.getId().intValue())))
    ...
    void getAllAnnexureQuestionsByFormNameIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("formName.equals=" + DEFAULT_FORM_NAME);

        // Get all the annexureQuestionsList where formName equals to UPDATED_FORM_NAME
        defaultAnnexureQuestionsShouldNotBeFound("formName.equals=" + UPDATED_FORM_NAME);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFormNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where formName not equals to DEFAULT_FORM_NAME
        defaultAnnexureQuestionsShouldNotBeFound("formName.notEquals=" + DEFAULT_FORM_NAME);

        // Get all the annexureQuestionsList where formName not equals to UPDATED_FORM_NAME
        defaultAnnexureQuestionsShouldBeFound("formName.notEquals=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureQuestionsByFormNameIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("formName.in=" + DEFAULT_FORM_NAME + "," + UPDATED_FORM_NAME);

        // Get all the annexureQuestionsList where formName equals to UPDATED_FORM_NAME
        defaultAnnexureQuestionsShouldNotBeFound("formName.in=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureQuestionsByFormNameContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("formName.contains=" + DEFAULT_FORM_NAME);

        // Get all the annexureQuestionsList where formName contains UPDATED_FORM_NAME
        defaultAnnexureQuestionsShouldNotBeFound("formName.contains=" + UPDATED_FORM_NAME);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFormNameNotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where formName does not contain DEFAULT_FORM_NAME
        defaultAnnexureQuestionsShouldNotBeFound("formName.doesNotContain=" + DEFAULT_FORM_NAME);

        // Get all the annexureQuestionsList where formName does not contain UPDATED_FORM_NAME
        defaultAnnexureQuestionsShouldBeFound("formName.doesNotContain=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureQuestionsByTypeIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("type.in=" + DEFAULT_TYPE + "," + UPDATED_TYPE);
    ...
    void getAllAnnexureQuestionsByTypeNotContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldNotBeFound("type.doesNotContain=" + DEFAULT_TYPE);

        // Get all the annexureQuestionsList where type does not contain UPDATED_TYPE
        defaultAnnexureQuestionsShouldBeFound("type.doesNotContain=" + UPDATED_TYPE);
    }
    ...
    void getAllAnnexureQuestionsBySubTypeIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldNotBeFound("subType.equals=" + UPDATED_SUB_TYPE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsBySubTypeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where subType not equals to DEFAULT_SUB_TYPE
        defaultAnnexureQuestionsShouldNotBeFound("subType.notEquals=" + DEFAULT_SUB_TYPE);

        // Get all the annexureQuestionsList where subType not equals to UPDATED_SUB_TYPE
        defaultAnnexureQuestionsShouldBeFound("subType.notEquals=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureQuestionsBySubTypeIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("subType.in=" + DEFAULT_SUB_TYPE + "," + UPDATED_SUB_TYPE);
    ...
    void getAllAnnexureQuestionsBySubTypeContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("subType.contains=" + DEFAULT_SUB_TYPE);

        // Get all the annexureQuestionsList where subType contains UPDATED_SUB_TYPE
        defaultAnnexureQuestionsShouldNotBeFound("subType.contains=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureQuestionsBySubTypeNotContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldNotBeFound("subType.doesNotContain=" + DEFAULT_SUB_TYPE);

        // Get all the annexureQuestionsList where subType does not contain UPDATED_SUB_TYPE
        defaultAnnexureQuestionsShouldBeFound("subType.doesNotContain=" + UPDATED_SUB_TYPE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where description equals to DEFAULT_DESCRIPTION
        defaultAnnexureQuestionsShouldBeFound("description.equals=" + DEFAULT_DESCRIPTION);

        // Get all the annexureQuestionsList where description equals to UPDATED_DESCRIPTION
        defaultAnnexureQuestionsShouldNotBeFound("description.equals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where description not equals to DEFAULT_DESCRIPTION
        defaultAnnexureQuestionsShouldNotBeFound("description.notEquals=" + DEFAULT_DESCRIPTION);

        // Get all the annexureQuestionsList where description not equals to UPDATED_DESCRIPTION
        defaultAnnexureQuestionsShouldBeFound("description.notEquals=" + UPDATED_DESCRIPTION);
    }
    ...
    void getAllAnnexureQuestionsByDescriptionIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("description.in=" + DEFAULT_DESCRIPTION + "," + UPDATED_DESCRIPTION);

        // Get all the annexureQuestionsList where description equals to UPDATED_DESCRIPTION
        defaultAnnexureQuestionsShouldNotBeFound("description.in=" + UPDATED_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureQuestionsByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where description contains DEFAULT_DESCRIPTION
        defaultAnnexureQuestionsShouldBeFound("description.contains=" + DEFAULT_DESCRIPTION);

        // Get all the annexureQuestionsList where description contains UPDATED_DESCRIPTION
        defaultAnnexureQuestionsShouldNotBeFound("description.contains=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where description does not contain DEFAULT_DESCRIPTION
        defaultAnnexureQuestionsShouldNotBeFound("description.doesNotContain=" + DEFAULT_DESCRIPTION);

        // Get all the annexureQuestionsList where description does not contain UPDATED_DESCRIPTION
        defaultAnnexureQuestionsShouldBeFound("description.doesNotContain=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField1IsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField1 equals to DEFAULT_FREE_FIELD_1
        defaultAnnexureQuestionsShouldBeFound("freeField1.equals=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureQuestionsList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultAnnexureQuestionsShouldNotBeFound("freeField1.equals=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField1IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField1 not equals to DEFAULT_FREE_FIELD_1
        defaultAnnexureQuestionsShouldNotBeFound("freeField1.notEquals=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureQuestionsList where freeField1 not equals to UPDATED_FREE_FIELD_1
        defaultAnnexureQuestionsShouldBeFound("freeField1.notEquals=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAnnexureQuestionsByFreeField1IsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField1.in=" + DEFAULT_FREE_FIELD_1 + "," + UPDATED_FREE_FIELD_1);

        // Get all the annexureQuestionsList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultAnnexureQuestionsShouldNotBeFound("freeField1.in=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAnnexureQuestionsByFreeField1ContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField1.contains=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureQuestionsList where freeField1 contains UPDATED_FREE_FIELD_1
        defaultAnnexureQuestionsShouldNotBeFound("freeField1.contains=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField1NotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField1 does not contain DEFAULT_FREE_FIELD_1
        defaultAnnexureQuestionsShouldNotBeFound("freeField1.doesNotContain=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureQuestionsList where freeField1 does not contain UPDATED_FREE_FIELD_1
        defaultAnnexureQuestionsShouldBeFound("freeField1.doesNotContain=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField2IsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField2 equals to DEFAULT_FREE_FIELD_2
        defaultAnnexureQuestionsShouldBeFound("freeField2.equals=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureQuestionsList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultAnnexureQuestionsShouldNotBeFound("freeField2.equals=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField2IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField2 not equals to DEFAULT_FREE_FIELD_2
        defaultAnnexureQuestionsShouldNotBeFound("freeField2.notEquals=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureQuestionsList where freeField2 not equals to UPDATED_FREE_FIELD_2
        defaultAnnexureQuestionsShouldBeFound("freeField2.notEquals=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAnnexureQuestionsByFreeField2IsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField2.in=" + DEFAULT_FREE_FIELD_2 + "," + UPDATED_FREE_FIELD_2);

        // Get all the annexureQuestionsList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultAnnexureQuestionsShouldNotBeFound("freeField2.in=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAnnexureQuestionsByFreeField2ContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField2.contains=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureQuestionsList where freeField2 contains UPDATED_FREE_FIELD_2
        defaultAnnexureQuestionsShouldNotBeFound("freeField2.contains=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField2NotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField2 does not contain DEFAULT_FREE_FIELD_2
        defaultAnnexureQuestionsShouldNotBeFound("freeField2.doesNotContain=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureQuestionsList where freeField2 does not contain UPDATED_FREE_FIELD_2
        defaultAnnexureQuestionsShouldBeFound("freeField2.doesNotContain=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField3IsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField3 equals to DEFAULT_FREE_FIELD_3
        defaultAnnexureQuestionsShouldBeFound("freeField3.equals=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureQuestionsList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultAnnexureQuestionsShouldNotBeFound("freeField3.equals=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField3IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField3 not equals to DEFAULT_FREE_FIELD_3
        defaultAnnexureQuestionsShouldNotBeFound("freeField3.notEquals=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureQuestionsList where freeField3 not equals to UPDATED_FREE_FIELD_3
        defaultAnnexureQuestionsShouldBeFound("freeField3.notEquals=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAnnexureQuestionsByFreeField3IsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField3.in=" + DEFAULT_FREE_FIELD_3 + "," + UPDATED_FREE_FIELD_3);

        // Get all the annexureQuestionsList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultAnnexureQuestionsShouldNotBeFound("freeField3.in=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAnnexureQuestionsByFreeField3ContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField3.contains=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureQuestionsList where freeField3 contains UPDATED_FREE_FIELD_3
        defaultAnnexureQuestionsShouldNotBeFound("freeField3.contains=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField3NotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField3 does not contain DEFAULT_FREE_FIELD_3
        defaultAnnexureQuestionsShouldNotBeFound("freeField3.doesNotContain=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureQuestionsList where freeField3 does not contain UPDATED_FREE_FIELD_3
        defaultAnnexureQuestionsShouldBeFound("freeField3.doesNotContain=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField4IsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField4 equals to DEFAULT_FREE_FIELD_4
        defaultAnnexureQuestionsShouldBeFound("freeField4.equals=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureQuestionsList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultAnnexureQuestionsShouldNotBeFound("freeField4.equals=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField4IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField4 not equals to DEFAULT_FREE_FIELD_4
        defaultAnnexureQuestionsShouldNotBeFound("freeField4.notEquals=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureQuestionsList where freeField4 not equals to UPDATED_FREE_FIELD_4
        defaultAnnexureQuestionsShouldBeFound("freeField4.notEquals=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAnnexureQuestionsByFreeField4IsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField4.in=" + DEFAULT_FREE_FIELD_4 + "," + UPDATED_FREE_FIELD_4);

        // Get all the annexureQuestionsList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultAnnexureQuestionsShouldNotBeFound("freeField4.in=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAnnexureQuestionsByFreeField4ContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("freeField4.contains=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureQuestionsList where freeField4 contains UPDATED_FREE_FIELD_4
        defaultAnnexureQuestionsShouldNotBeFound("freeField4.contains=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByFreeField4NotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where freeField4 does not contain DEFAULT_FREE_FIELD_4
        defaultAnnexureQuestionsShouldNotBeFound("freeField4.doesNotContain=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureQuestionsList where freeField4 does not contain UPDATED_FREE_FIELD_4
        defaultAnnexureQuestionsShouldBeFound("freeField4.doesNotContain=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate equals to DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate equals to UPDATED_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate not equals to UPDATED_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }
    ...
    void getAllAnnexureQuestionsByCreatedDateIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate equals to UPDATED_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate is less than DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate is less than UPDATED_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultAnnexureQuestionsShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the annexureQuestionsList where createdDate is greater than SMALLER_CREATED_DATE
        defaultAnnexureQuestionsShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    void getAllAnnexureQuestionsByCreatedByIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("createdBy.equals=" + DEFAULT_CREATED_BY);

        // Get all the annexureQuestionsList where createdBy equals to UPDATED_CREATED_BY
        defaultAnnexureQuestionsShouldNotBeFound("createdBy.equals=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdBy not equals to DEFAULT_CREATED_BY
        defaultAnnexureQuestionsShouldNotBeFound("createdBy.notEquals=" + DEFAULT_CREATED_BY);

        // Get all the annexureQuestionsList where createdBy not equals to UPDATED_CREATED_BY
        defaultAnnexureQuestionsShouldBeFound("createdBy.notEquals=" + UPDATED_CREATED_BY);
    }
    ...
    void getAllAnnexureQuestionsByCreatedByIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("createdBy.in=" + DEFAULT_CREATED_BY + "," + UPDATED_CREATED_BY);

        // Get all the annexureQuestionsList where createdBy equals to UPDATED_CREATED_BY
        defaultAnnexureQuestionsShouldNotBeFound("createdBy.in=" + UPDATED_CREATED_BY);
    }
    ...
    void getAllAnnexureQuestionsByCreatedByContainsSomething() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("createdBy.contains=" + DEFAULT_CREATED_BY);

        // Get all the annexureQuestionsList where createdBy contains UPDATED_CREATED_BY
        defaultAnnexureQuestionsShouldNotBeFound("createdBy.contains=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByCreatedByNotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where createdBy does not contain DEFAULT_CREATED_BY
        defaultAnnexureQuestionsShouldNotBeFound("createdBy.doesNotContain=" + DEFAULT_CREATED_BY);

        // Get all the annexureQuestionsList where createdBy does not contain UPDATED_CREATED_BY
        defaultAnnexureQuestionsShouldBeFound("createdBy.doesNotContain=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified equals to DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.equals=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified equals to UPDATED_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.equals=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified not equals to DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.notEquals=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified not equals to UPDATED_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.notEquals=" + UPDATED_LAST_MODIFIED);
    }
    ...
    void getAllAnnexureQuestionsByLastModifiedIsInShouldWork() throws Exception {
        ...
        defaultAnnexureQuestionsShouldBeFound("lastModified.in=" + DEFAULT_LAST_MODIFIED + "," + UPDATED_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified equals to UPDATED_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.in=" + UPDATED_LAST_MODIFIED);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultAnnexureQuestionsShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureQuestionsList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultAnnexureQuestionsShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModifiedBy equals to DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldBeFound("lastModifiedBy.equals=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureQuestionsList where lastModifiedBy equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldNotBeFound("lastModifiedBy.equals=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModifiedBy not equals to DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldNotBeFound("lastModifiedBy.notEquals=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureQuestionsList where lastModifiedBy not equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldBeFound("lastModifiedBy.notEquals=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByIsInShouldWork() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModifiedBy in DEFAULT_LAST_MODIFIED_BY or UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldBeFound("lastModifiedBy.in=" + DEFAULT_LAST_MODIFIED_BY + "," + UPDATED_LAST_MODIFIED_BY);

        // Get all the annexureQuestionsList where lastModifiedBy equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldNotBeFound("lastModifiedBy.in=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByIsNullOrNotNull() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);
    ...
    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModifiedBy contains DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldBeFound("lastModifiedBy.contains=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureQuestionsList where lastModifiedBy contains UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldNotBeFound("lastModifiedBy.contains=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByLastModifiedByNotContainsSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);

        // Get all the annexureQuestionsList where lastModifiedBy does not contain DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldNotBeFound("lastModifiedBy.doesNotContain=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureQuestionsList where lastModifiedBy does not contain UPDATED_LAST_MODIFIED_BY
        defaultAnnexureQuestionsShouldBeFound("lastModifiedBy.doesNotContain=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByAnnexureAnswersIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);
        ...
        defaultAnnexureQuestionsShouldBeFound("annexureAnswersId.equals=" + annexureAnswersId);

        // Get all the annexureQuestionsList where annexureAnswers equals to (annexureAnswersId + 1)
        defaultAnnexureQuestionsShouldNotBeFound("annexureAnswersId.equals=" + (annexureAnswersId + 1));
    }

    @Test
    @Transactional
    void getAllAnnexureQuestionsByAuditIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);
        Audit audit;
        ...
        em.persist(audit);
        em.flush();
        annexureQuestions.setAudit(audit);
        annexureQuestionsRepository.saveAndFlush(annexureQuestions);
        Long auditId = audit.getId();

        // Get all the annexureQuestionsList where audit equals to auditId
        defaultAnnexureQuestionsShouldBeFound("auditId.equals=" + auditId);

        // Get all the annexureQuestionsList where audit equals to (auditId + 1)
        defaultAnnexureQuestionsShouldNotBeFound("auditId.equals=" + (auditId + 1));
    }

    /**
     * Executes the search, and checks that the default entity is returned.
     */
    private void defaultAnnexureQuestionsShouldBeFound(String filter) throws Exception {
        restAnnexureQuestionsMockMvc
     ...
     */
    private void defaultAnnexureQuestionsShouldNotBeFound(String filter) throws Exception {
        restAnnexureQuestionsMockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingAnnexureQuestions() throws Exception {
        // Get the annexureQuestions
        restAnnexureQuestionsMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNewAnnexureQuestions() throws Exception {
        ...
        AnnexureQuestions updatedAnnexureQuestions = annexureQuestionsRepository.findById(annexureQuestions.getId()).get();
        ...
        updatedAnnexureQuestions
            ...
            .lastModified(UPDATED_LAST_MODIFIED)
            .lastModifiedBy(UPDATED_LAST_MODIFIED_BY);
        AnnexureQuestionsDTO annexureQuestionsDTO = annexureQuestionsMapper.toDto(updatedAnnexureQuestions);
        ...
        AnnexureQuestions testAnnexureQuestions = annexureQuestionsList.get(annexureQuestionsList.size() - 1);
        assertThat(testAnnexureQuestions.getFormName()).isEqualTo(UPDATED_FORM_NAME);
        ...
        assertThat(testAnnexureQuestions.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testAnnexureQuestions.getFreeField1()).isEqualTo(UPDATED_FREE_FIELD_1);
        assertThat(testAnnexureQuestions.getFreeField2()).isEqualTo(UPDATED_FREE_FIELD_2);
        assertThat(testAnnexureQuestions.getFreeField3()).isEqualTo(UPDATED_FREE_FIELD_3);
        assertThat(testAnnexureQuestions.getFreeField4()).isEqualTo(UPDATED_FREE_FIELD_4);
        assertThat(testAnnexureQuestions.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testAnnexureQuestions.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testAnnexureQuestions.getLastModified()).isEqualTo(UPDATED_LAST_MODIFIED);
        assertThat(testAnnexureQuestions.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
    }
    ...
    void putWithMissingIdPathParamAnnexureQuestions() throws Exception {
        ...
        restAnnexureQuestionsMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(annexureQuestionsDTO))
            )
    ...
    void partialUpdateAnnexureQuestionsWithPatch() throws Exception {
        ...
        partialUpdatedAnnexureQuestions.subType(UPDATED_SUB_TYPE).freeField4(UPDATED_FREE_FIELD_4).createdDate(UPDATED_CREATED_DATE);

        restAnnexureQuestionsMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedAnnexureQuestions.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedAnnexureQuestions))
            )
            .andExpect(status().isOk());
    ...
    void deleteAnnexureQuestions() throws Exception {
        ...
        restAnnexureQuestionsMockMvc
            .perform(delete(ENTITY_API_URL_ID, annexureQuestions.getId()).accept(MediaType.APPLICATION_JSON))
