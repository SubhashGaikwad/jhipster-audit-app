...
class AnnexureAnswersResourceIT {
    ...
    void createAnnexureAnswers() throws Exception {
        ...
        AnnexureAnswersDTO annexureAnswersDTO = annexureAnswersMapper.toDto(annexureAnswers);
        restAnnexureAnswersMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(annexureAnswersDTO))
            )
        ...
        AnnexureAnswers testAnnexureAnswers = annexureAnswersList.get(annexureAnswersList.size() - 1);
        ...
        assertThat(testAnnexureAnswers.getCompliance()).isEqualTo(DEFAULT_COMPLIANCE);
        assertThat(testAnnexureAnswers.getComment()).isEqualTo(DEFAULT_COMMENT);
        assertThat(testAnnexureAnswers.getFreeField1()).isEqualTo(DEFAULT_FREE_FIELD_1);
        assertThat(testAnnexureAnswers.getFreeField2()).isEqualTo(DEFAULT_FREE_FIELD_2);
        assertThat(testAnnexureAnswers.getFreeField3()).isEqualTo(DEFAULT_FREE_FIELD_3);
        assertThat(testAnnexureAnswers.getFreeField4()).isEqualTo(DEFAULT_FREE_FIELD_4);
        assertThat(testAnnexureAnswers.getRemark()).isEqualTo(DEFAULT_REMARK);
        assertThat(testAnnexureAnswers.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testAnnexureAnswers.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testAnnexureAnswers.getLastModified()).isEqualTo(DEFAULT_LAST_MODIFIED);
        assertThat(testAnnexureAnswers.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
    }
    ...
    void getAllAnnexureAnswers() throws Exception {
        ...
        restAnnexureAnswersMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(annexureAnswers.getId().intValue())))
    ...
    void getAllAnnexureAnswersByFormNameIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("formName.equals=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureAnswersByFormNameIsNotEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("formName.notEquals=" + DEFAULT_FORM_NAME);

        // Get all the annexureAnswersList where formName not equals to UPDATED_FORM_NAME
        defaultAnnexureAnswersShouldBeFound("formName.notEquals=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureAnswersByFormNameIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("formName.in=" + DEFAULT_FORM_NAME + "," + UPDATED_FORM_NAME);
    ...
    void getAllAnnexureAnswersByFormNameContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("formName.contains=" + DEFAULT_FORM_NAME);

        // Get all the annexureAnswersList where formName contains UPDATED_FORM_NAME
        defaultAnnexureAnswersShouldNotBeFound("formName.contains=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureAnswersByFormNameNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("formName.doesNotContain=" + DEFAULT_FORM_NAME);

        // Get all the annexureAnswersList where formName does not contain UPDATED_FORM_NAME
        defaultAnnexureAnswersShouldBeFound("formName.doesNotContain=" + UPDATED_FORM_NAME);
    }
    ...
    void getAllAnnexureAnswersByTypeIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("type.in=" + DEFAULT_TYPE + "," + UPDATED_TYPE);
    ...
    void getAllAnnexureAnswersByTypeNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("type.doesNotContain=" + DEFAULT_TYPE);
    ...
    void getAllAnnexureAnswersBySubTypeIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("subType.equals=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureAnswersBySubTypeIsNotEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("subType.notEquals=" + DEFAULT_SUB_TYPE);

        // Get all the annexureAnswersList where subType not equals to UPDATED_SUB_TYPE
        defaultAnnexureAnswersShouldBeFound("subType.notEquals=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureAnswersBySubTypeIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("subType.in=" + DEFAULT_SUB_TYPE + "," + UPDATED_SUB_TYPE);
    ...
    void getAllAnnexureAnswersBySubTypeContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("subType.contains=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureAnswersBySubTypeNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("subType.doesNotContain=" + DEFAULT_SUB_TYPE);

        // Get all the annexureAnswersList where subType does not contain UPDATED_SUB_TYPE
        defaultAnnexureAnswersShouldBeFound("subType.doesNotContain=" + UPDATED_SUB_TYPE);
    }
    ...
    void getAllAnnexureAnswersByComplianceIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("compliance.equals=" + DEFAULT_COMPLIANCE);

        // Get all the annexureAnswersList where compliance equals to UPDATED_COMPLIANCE
        defaultAnnexureAnswersShouldNotBeFound("compliance.equals=" + UPDATED_COMPLIANCE);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByComplianceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where compliance not equals to DEFAULT_COMPLIANCE
        defaultAnnexureAnswersShouldNotBeFound("compliance.notEquals=" + DEFAULT_COMPLIANCE);

        // Get all the annexureAnswersList where compliance not equals to UPDATED_COMPLIANCE
        defaultAnnexureAnswersShouldBeFound("compliance.notEquals=" + UPDATED_COMPLIANCE);
    }
    ...
    void getAllAnnexureAnswersByComplianceIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("compliance.in=" + DEFAULT_COMPLIANCE + "," + UPDATED_COMPLIANCE);

        // Get all the annexureAnswersList where compliance equals to UPDATED_COMPLIANCE
        defaultAnnexureAnswersShouldNotBeFound("compliance.in=" + UPDATED_COMPLIANCE);
    }
    ...
    void getAllAnnexureAnswersByCommentIsNotEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("comment.notEquals=" + DEFAULT_COMMENT);
    ...
    void getAllAnnexureAnswersByCommentIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("comment.in=" + DEFAULT_COMMENT + "," + UPDATED_COMMENT);
    ...
    void getAllAnnexureAnswersByCommentContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("comment.contains=" + UPDATED_COMMENT);
    }
    ...
    void getAllAnnexureAnswersByCommentNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("comment.doesNotContain=" + DEFAULT_COMMENT);

        // Get all the annexureAnswersList where comment does not contain UPDATED_COMMENT
        defaultAnnexureAnswersShouldBeFound("comment.doesNotContain=" + UPDATED_COMMENT);
    }
    ...
    void getAllAnnexureAnswersByFreeField1IsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField1.equals=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureAnswersList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultAnnexureAnswersShouldNotBeFound("freeField1.equals=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField1IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField1 not equals to DEFAULT_FREE_FIELD_1
        defaultAnnexureAnswersShouldNotBeFound("freeField1.notEquals=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureAnswersList where freeField1 not equals to UPDATED_FREE_FIELD_1
        defaultAnnexureAnswersShouldBeFound("freeField1.notEquals=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAnnexureAnswersByFreeField1IsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField1.in=" + DEFAULT_FREE_FIELD_1 + "," + UPDATED_FREE_FIELD_1);

        // Get all the annexureAnswersList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultAnnexureAnswersShouldNotBeFound("freeField1.in=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAnnexureAnswersByFreeField1ContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField1.contains=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureAnswersList where freeField1 contains UPDATED_FREE_FIELD_1
        defaultAnnexureAnswersShouldNotBeFound("freeField1.contains=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField1NotContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField1 does not contain DEFAULT_FREE_FIELD_1
        defaultAnnexureAnswersShouldNotBeFound("freeField1.doesNotContain=" + DEFAULT_FREE_FIELD_1);

        // Get all the annexureAnswersList where freeField1 does not contain UPDATED_FREE_FIELD_1
        defaultAnnexureAnswersShouldBeFound("freeField1.doesNotContain=" + UPDATED_FREE_FIELD_1);
    }
    ...
    void getAllAnnexureAnswersByFreeField2IsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField2.equals=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureAnswersList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultAnnexureAnswersShouldNotBeFound("freeField2.equals=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField2IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField2 not equals to DEFAULT_FREE_FIELD_2
        defaultAnnexureAnswersShouldNotBeFound("freeField2.notEquals=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureAnswersList where freeField2 not equals to UPDATED_FREE_FIELD_2
        defaultAnnexureAnswersShouldBeFound("freeField2.notEquals=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAnnexureAnswersByFreeField2IsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField2.in=" + DEFAULT_FREE_FIELD_2 + "," + UPDATED_FREE_FIELD_2);

        // Get all the annexureAnswersList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultAnnexureAnswersShouldNotBeFound("freeField2.in=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAnnexureAnswersByFreeField2ContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField2.contains=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureAnswersList where freeField2 contains UPDATED_FREE_FIELD_2
        defaultAnnexureAnswersShouldNotBeFound("freeField2.contains=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField2NotContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField2 does not contain DEFAULT_FREE_FIELD_2
        defaultAnnexureAnswersShouldNotBeFound("freeField2.doesNotContain=" + DEFAULT_FREE_FIELD_2);

        // Get all the annexureAnswersList where freeField2 does not contain UPDATED_FREE_FIELD_2
        defaultAnnexureAnswersShouldBeFound("freeField2.doesNotContain=" + UPDATED_FREE_FIELD_2);
    }
    ...
    void getAllAnnexureAnswersByFreeField3IsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField3.equals=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureAnswersList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultAnnexureAnswersShouldNotBeFound("freeField3.equals=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField3IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField3 not equals to DEFAULT_FREE_FIELD_3
        defaultAnnexureAnswersShouldNotBeFound("freeField3.notEquals=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureAnswersList where freeField3 not equals to UPDATED_FREE_FIELD_3
        defaultAnnexureAnswersShouldBeFound("freeField3.notEquals=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAnnexureAnswersByFreeField3IsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField3.in=" + DEFAULT_FREE_FIELD_3 + "," + UPDATED_FREE_FIELD_3);

        // Get all the annexureAnswersList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultAnnexureAnswersShouldNotBeFound("freeField3.in=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAnnexureAnswersByFreeField3ContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField3.contains=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureAnswersList where freeField3 contains UPDATED_FREE_FIELD_3
        defaultAnnexureAnswersShouldNotBeFound("freeField3.contains=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField3NotContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField3 does not contain DEFAULT_FREE_FIELD_3
        defaultAnnexureAnswersShouldNotBeFound("freeField3.doesNotContain=" + DEFAULT_FREE_FIELD_3);

        // Get all the annexureAnswersList where freeField3 does not contain UPDATED_FREE_FIELD_3
        defaultAnnexureAnswersShouldBeFound("freeField3.doesNotContain=" + UPDATED_FREE_FIELD_3);
    }
    ...
    void getAllAnnexureAnswersByFreeField4IsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField4.equals=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureAnswersList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultAnnexureAnswersShouldNotBeFound("freeField4.equals=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField4IsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField4 not equals to DEFAULT_FREE_FIELD_4
        defaultAnnexureAnswersShouldNotBeFound("freeField4.notEquals=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureAnswersList where freeField4 not equals to UPDATED_FREE_FIELD_4
        defaultAnnexureAnswersShouldBeFound("freeField4.notEquals=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAnnexureAnswersByFreeField4IsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField4.in=" + DEFAULT_FREE_FIELD_4 + "," + UPDATED_FREE_FIELD_4);

        // Get all the annexureAnswersList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultAnnexureAnswersShouldNotBeFound("freeField4.in=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAnnexureAnswersByFreeField4ContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("freeField4.contains=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureAnswersList where freeField4 contains UPDATED_FREE_FIELD_4
        defaultAnnexureAnswersShouldNotBeFound("freeField4.contains=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByFreeField4NotContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where freeField4 does not contain DEFAULT_FREE_FIELD_4
        defaultAnnexureAnswersShouldNotBeFound("freeField4.doesNotContain=" + DEFAULT_FREE_FIELD_4);

        // Get all the annexureAnswersList where freeField4 does not contain UPDATED_FREE_FIELD_4
        defaultAnnexureAnswersShouldBeFound("freeField4.doesNotContain=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void getAllAnnexureAnswersByRemarkIsNotEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("remark.notEquals=" + DEFAULT_REMARK);
    ...
    void getAllAnnexureAnswersByRemarkIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("remark.in=" + DEFAULT_REMARK + "," + UPDATED_REMARK);
    ...
    void getAllAnnexureAnswersByRemarkNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("remark.doesNotContain=" + DEFAULT_REMARK);

        // Get all the annexureAnswersList where remark does not contain UPDATED_REMARK
        defaultAnnexureAnswersShouldBeFound("remark.doesNotContain=" + UPDATED_REMARK);
    }
    ...
    void getAllAnnexureAnswersByCreatedDateIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("createdDate.equals=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate equals to UPDATED_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.equals=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdDate not equals to DEFAULT_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.notEquals=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate not equals to UPDATED_CREATED_DATE
        defaultAnnexureAnswersShouldBeFound("createdDate.notEquals=" + UPDATED_CREATED_DATE);
    }
    ...
    void getAllAnnexureAnswersByCreatedDateIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("createdDate.in=" + DEFAULT_CREATED_DATE + "," + UPDATED_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate equals to UPDATED_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.in=" + UPDATED_CREATED_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdDate is greater than or equal to DEFAULT_CREATED_DATE
        defaultAnnexureAnswersShouldBeFound("createdDate.greaterThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate is greater than or equal to UPDATED_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.greaterThanOrEqual=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdDate is less than or equal to DEFAULT_CREATED_DATE
        defaultAnnexureAnswersShouldBeFound("createdDate.lessThanOrEqual=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate is less than or equal to SMALLER_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.lessThanOrEqual=" + SMALLER_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedDateIsLessThanSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdDate is less than DEFAULT_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.lessThan=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate is less than UPDATED_CREATED_DATE
        defaultAnnexureAnswersShouldBeFound("createdDate.lessThan=" + UPDATED_CREATED_DATE);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdDate is greater than DEFAULT_CREATED_DATE
        defaultAnnexureAnswersShouldNotBeFound("createdDate.greaterThan=" + DEFAULT_CREATED_DATE);

        // Get all the annexureAnswersList where createdDate is greater than SMALLER_CREATED_DATE
        defaultAnnexureAnswersShouldBeFound("createdDate.greaterThan=" + SMALLER_CREATED_DATE);
    }
    ...
    void getAllAnnexureAnswersByCreatedByIsEqualToSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("createdBy.equals=" + DEFAULT_CREATED_BY);

        // Get all the annexureAnswersList where createdBy equals to UPDATED_CREATED_BY
        defaultAnnexureAnswersShouldNotBeFound("createdBy.equals=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByCreatedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where createdBy not equals to DEFAULT_CREATED_BY
        defaultAnnexureAnswersShouldNotBeFound("createdBy.notEquals=" + DEFAULT_CREATED_BY);

        // Get all the annexureAnswersList where createdBy not equals to UPDATED_CREATED_BY
        defaultAnnexureAnswersShouldBeFound("createdBy.notEquals=" + UPDATED_CREATED_BY);
    }
    ...
    void getAllAnnexureAnswersByCreatedByIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("createdBy.in=" + DEFAULT_CREATED_BY + "," + UPDATED_CREATED_BY);

        // Get all the annexureAnswersList where createdBy equals to UPDATED_CREATED_BY
        defaultAnnexureAnswersShouldNotBeFound("createdBy.in=" + UPDATED_CREATED_BY);
    }
    ...
    void getAllAnnexureAnswersByCreatedByContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("createdBy.contains=" + DEFAULT_CREATED_BY);

        // Get all the annexureAnswersList where createdBy contains UPDATED_CREATED_BY
        defaultAnnexureAnswersShouldNotBeFound("createdBy.contains=" + UPDATED_CREATED_BY);
    }
    ...
    void getAllAnnexureAnswersByCreatedByNotContainsSomething() throws Exception {
        ...
        defaultAnnexureAnswersShouldNotBeFound("createdBy.doesNotContain=" + DEFAULT_CREATED_BY);

        // Get all the annexureAnswersList where createdBy does not contain UPDATED_CREATED_BY
        defaultAnnexureAnswersShouldBeFound("createdBy.doesNotContain=" + UPDATED_CREATED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified equals to DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.equals=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified equals to UPDATED_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.equals=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified not equals to DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.notEquals=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified not equals to UPDATED_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.notEquals=" + UPDATED_LAST_MODIFIED);
    }
    ...
    void getAllAnnexureAnswersByLastModifiedIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("lastModified.in=" + DEFAULT_LAST_MODIFIED + "," + UPDATED_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified equals to UPDATED_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.in=" + UPDATED_LAST_MODIFIED);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified is greater than or equal to DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.greaterThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified is greater than or equal to UPDATED_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.greaterThanOrEqual=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified is less than or equal to DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.lessThanOrEqual=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified is less than or equal to SMALLER_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.lessThanOrEqual=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsLessThanSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified is less than DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.lessThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified is less than UPDATED_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.lessThan=" + UPDATED_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedIsGreaterThanSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModified is greater than DEFAULT_LAST_MODIFIED
        defaultAnnexureAnswersShouldNotBeFound("lastModified.greaterThan=" + DEFAULT_LAST_MODIFIED);

        // Get all the annexureAnswersList where lastModified is greater than SMALLER_LAST_MODIFIED
        defaultAnnexureAnswersShouldBeFound("lastModified.greaterThan=" + SMALLER_LAST_MODIFIED);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModifiedBy equals to DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldBeFound("lastModifiedBy.equals=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureAnswersList where lastModifiedBy equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldNotBeFound("lastModifiedBy.equals=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModifiedBy not equals to DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldNotBeFound("lastModifiedBy.notEquals=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureAnswersList where lastModifiedBy not equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldBeFound("lastModifiedBy.notEquals=" + UPDATED_LAST_MODIFIED_BY);
    }
    ...
    void getAllAnnexureAnswersByLastModifiedByIsInShouldWork() throws Exception {
        ...
        defaultAnnexureAnswersShouldBeFound("lastModifiedBy.in=" + DEFAULT_LAST_MODIFIED_BY + "," + UPDATED_LAST_MODIFIED_BY);

        // Get all the annexureAnswersList where lastModifiedBy equals to UPDATED_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldNotBeFound("lastModifiedBy.in=" + UPDATED_LAST_MODIFIED_BY);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedByContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModifiedBy contains DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldBeFound("lastModifiedBy.contains=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureAnswersList where lastModifiedBy contains UPDATED_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldNotBeFound("lastModifiedBy.contains=" + UPDATED_LAST_MODIFIED_BY);
    }

    @Test
    @Transactional
    void getAllAnnexureAnswersByLastModifiedByNotContainsSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);

        // Get all the annexureAnswersList where lastModifiedBy does not contain DEFAULT_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldNotBeFound("lastModifiedBy.doesNotContain=" + DEFAULT_LAST_MODIFIED_BY);

        // Get all the annexureAnswersList where lastModifiedBy does not contain UPDATED_LAST_MODIFIED_BY
        defaultAnnexureAnswersShouldBeFound("lastModifiedBy.doesNotContain=" + UPDATED_LAST_MODIFIED_BY);
    }
    ...
    @Test
    @Transactional
    void getAllAnnexureAnswersByAnnexureQuestionsIsEqualToSomething() throws Exception {
        // Initialize the database
        annexureAnswersRepository.saveAndFlush(annexureAnswers);
        ...
        defaultAnnexureAnswersShouldBeFound("annexureQuestionsId.equals=" + annexureQuestionsId);

        // Get all the annexureAnswersList where annexureQuestions equals to (annexureQuestionsId + 1)
        defaultAnnexureAnswersShouldNotBeFound("annexureQuestionsId.equals=" + (annexureQuestionsId + 1));
    }

    /**
     * Executes the search, and checks that the default entity is returned.
     */
    private void defaultAnnexureAnswersShouldBeFound(String filter) throws Exception {
        restAnnexureAnswersMockMvc
     ...
     */
    private void defaultAnnexureAnswersShouldNotBeFound(String filter) throws Exception {
        restAnnexureAnswersMockMvc
            .perform(get(ENTITY_API_URL + "?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingAnnexureAnswers() throws Exception {
        // Get the annexureAnswers
        restAnnexureAnswersMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNewAnnexureAnswers() throws Exception {
        ...
        AnnexureAnswers updatedAnnexureAnswers = annexureAnswersRepository.findById(annexureAnswers.getId()).get();
        ...
        updatedAnnexureAnswers
            ...
            .lastModified(UPDATED_LAST_MODIFIED)
            .lastModifiedBy(UPDATED_LAST_MODIFIED_BY);
        AnnexureAnswersDTO annexureAnswersDTO = annexureAnswersMapper.toDto(updatedAnnexureAnswers);
        ...
        assertThat(testAnnexureAnswers.getCompliance()).isEqualTo(UPDATED_COMPLIANCE);
        assertThat(testAnnexureAnswers.getComment()).isEqualTo(UPDATED_COMMENT);
        assertThat(testAnnexureAnswers.getFreeField1()).isEqualTo(UPDATED_FREE_FIELD_1);
        assertThat(testAnnexureAnswers.getFreeField2()).isEqualTo(UPDATED_FREE_FIELD_2);
        assertThat(testAnnexureAnswers.getFreeField3()).isEqualTo(UPDATED_FREE_FIELD_3);
        assertThat(testAnnexureAnswers.getFreeField4()).isEqualTo(UPDATED_FREE_FIELD_4);
        assertThat(testAnnexureAnswers.getRemark()).isEqualTo(UPDATED_REMARK);
        assertThat(testAnnexureAnswers.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testAnnexureAnswers.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testAnnexureAnswers.getLastModified()).isEqualTo(UPDATED_LAST_MODIFIED);
        assertThat(testAnnexureAnswers.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
    }
    ...
    void putWithMissingIdPathParamAnnexureAnswers() throws Exception {
        ...
        restAnnexureAnswersMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(annexureAnswersDTO))
            )
        ...
        restAnnexureAnswersMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedAnnexureAnswers.getId())
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedAnnexureAnswers))
            )
            .andExpect(status().isOk());
    ...
    void deleteAnnexureAnswers() throws Exception {
        ...
        restAnnexureAnswersMockMvc
            .perform(delete(ENTITY_API_URL_ID, annexureAnswers.getId()).accept(MediaType.APPLICATION_JSON))
