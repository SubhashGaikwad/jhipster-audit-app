...
class AuditPatientMonitoringFormTest {
    ...
    void equalsVerifier() throws Exception {
        ...
        assertThat(auditPatientMonitoringForm1).isEqualTo(auditPatientMonitoringForm2);
        auditPatientMonitoringForm2.setId(2L);
        assertThat(auditPatientMonitoringForm1).isNotEqualTo(auditPatientMonitoringForm2);
